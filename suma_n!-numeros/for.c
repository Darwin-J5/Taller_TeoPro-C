...
int main() {
    ...
    if (n == 0) {
        ...
        /*de otro modo, se crea un bucle donde i = 1 y se repetira hasta que
        i sea mayor o igual a n*/
        for (int i = 1; i <= n; i ++) {
           ...
           //se actualiza el valor de fact y mult a 1 para realizar las multiplicaciones
            ...
            /*se crea un bucle donde j = 1 que se repetira hasta que j equivalga
            a el valor actual de i*/
            for (int j = 1; j <= i; j ++) {
        ...
        //se crea un bucle donde k = 1 que se repetira hasta que k equivalga a n
        for (int k = 1; k <= n; k++) {
